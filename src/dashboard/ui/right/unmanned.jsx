  ...
  return (
    <BlockRC
      ...
      <div
        ...
        style={{
          background: `url("${withBasePath("/image/u/u-t.png")}"),url("${withBasePath("/image/u/u-bg1.png")}")`,
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] pt-2 gap-x-2">
          ...
          <div className="">
            <img src={withBasePath("/image/u/u-m.png")} alt="" />
          </div>
          <div className="-translate-y-2">
            <div className="flex">
        ...
        <div className="flex">
          <div
            ...
            style={{
              background: `url("${withBasePath("/image/u/u-line.png")}")`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "100% 100%",
              backgroundPosition: "0 0"
            }}>
            <img className="mr-2" src={withBasePath("/image/u/u-i.svg")} alt="" />
          ...
          <div
            ...
            style={{
              background: `url("${withBasePath("/image/u/u-line-h.png")}") no-repeat`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "100% 100%",
              backgroundPosition: "0 0"
            }}>
